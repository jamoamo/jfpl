...
class JsonPlayer
{
	...
	public void setInfluenceRank(int influenceRank)
	{
	...
	public void setInfluenceRankType(int influenceRankType)
	{
	...
	public void setCreativityRank(int creativityRank)
	{
	...
	public void setCreativityRankType(int creativityRankType)
	{
	...
	public void setThreatRankType(int threatRankType)
	{
	...
	public void setIctIndexRank(int ictIndexRank)
	{
	...
	public void setIctIndexRankType(int ictIndexRankType)
	{
		this.ictIndexRankType = ictIndexRankType;
	}

	public int getCornersAndIndirectFreekicksOrder()
	{
		return cornersAndIndirectFreekicksOrder;
	}

	public void setCornersAndIndirectFreekicksOrder(int cornersAndIndirectFreekicksOrder)
	{
	...
	public int getDirectFreekicksOrder()
	{
		return directFreekicksOrder;
	}

	public void setDirectFreekicksOrder(int directFreekicksOrder)
	{
	...
	public void setPenaltiesOrder(int penaltiesOrder)
	{
