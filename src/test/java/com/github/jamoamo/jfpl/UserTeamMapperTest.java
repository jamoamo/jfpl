...
public class UserTeamMapperTest
{
	...
	public void testMapUserTeam()
	{
		...
		assertEquals(56, result.getPicks().get(0).getPurchasingPrice());
		assertEquals(57, result.getPicks().get(0).getSellingPrice());
		assertEquals("Two", result.getPicks().get(1).getPlayer().getLastName());
		assertEquals(56, result.getPicks().get(1).getPurchasingPrice());
		assertEquals(57, result.getPicks().get(1).getSellingPrice());
		assertEquals("Three", result.getPicks().get(2).getPlayer().getLastName());
		assertEquals(56, result.getPicks().get(2).getPurchasingPrice());
		assertEquals(57, result.getPicks().get(2).getSellingPrice());
		assertEquals("Four", result.getPicks().get(3).getPlayer().getLastName());
		assertEquals(56, result.getPicks().get(3).getPurchasingPrice());
		assertEquals(57, result.getPicks().get(3).getSellingPrice());
		assertEquals("Five", result.getPicks().get(4).getPlayer().getLastName());
		assertEquals(56, result.getPicks().get(4).getPurchasingPrice());
		assertEquals(57, result.getPicks().get(4).getSellingPrice());
		assertEquals("Six", result.getPicks().get(5).getPlayer().getLastName());
		assertEquals(56, result.getPicks().get(5).getPurchasingPrice());
		assertEquals(57, result.getPicks().get(5).getSellingPrice());
		assertEquals("Seven", result.getPicks().get(6).getPlayer().getLastName());
		assertEquals(56, result.getPicks().get(6).getPurchasingPrice());
		assertEquals(57, result.getPicks().get(6).getSellingPrice());
		assertEquals("Eight", result.getPicks().get(7).getPlayer().getLastName());
		assertEquals(56, result.getPicks().get(7).getPurchasingPrice());
		assertEquals(57, result.getPicks().get(7).getSellingPrice());
		assertEquals("Nine", result.getPicks().get(8).getPlayer().getLastName());
		assertEquals(56, result.getPicks().get(8).getPurchasingPrice());
		assertEquals(57, result.getPicks().get(8).getSellingPrice());
		assertEquals("Ten", result.getPicks().get(9).getPlayer().getLastName());
		assertEquals(56, result.getPicks().get(9).getPurchasingPrice());
		assertEquals(57, result.getPicks().get(9).getSellingPrice());
		assertEquals("Eleven", result.getPicks().get(10).getPlayer().getLastName());
		assertEquals(56, result.getPicks().get(10).getPurchasingPrice());
		assertEquals(57, result.getPicks().get(10).getSellingPrice());
		assertEquals("Twelve", result.getPicks().get(11).getPlayer().getLastName());
		assertEquals(56, result.getPicks().get(11).getPurchasingPrice());
		assertEquals(57, result.getPicks().get(11).getSellingPrice());
		assertEquals("Thirteen", result.getPicks().get(12).getPlayer().getLastName());
		assertEquals(56, result.getPicks().get(12).getPurchasingPrice());
		assertEquals(57, result.getPicks().get(12).getSellingPrice());
		assertEquals("Fourteen", result.getPicks().get(13).getPlayer().getLastName());
		assertEquals(56, result.getPicks().get(13).getPurchasingPrice());
		assertEquals(57, result.getPicks().get(13).getSellingPrice());
		assertEquals("Fifteen", result.getPicks().get(14).getPlayer().getLastName());
		assertEquals(56, result.getPicks().get(14).getPurchasingPrice());
		assertEquals(57, result.getPicks().get(14).getSellingPrice());
